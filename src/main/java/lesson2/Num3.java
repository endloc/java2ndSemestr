...
//        BankAccount account5 = new BankAccount(acc5, id5, money5);
        ...
        int acc4, id4, acc5, id5;
        double money4, money5, amount45;
        BankAccount account4, account5;
        do {
            System.out.println("money transfer:");
            System.out.println("1st acc (from) ->");
            acc4 = scanner.nextInt();
            id4 = scanner.nextInt();
            money4 = scanner.nextDouble();
            System.out.println("2nd acc (to) ->");
            acc5 = scanner.nextInt();
            id5 = scanner.nextInt();
            money5 = scanner.nextDouble();
            System.out.println("transfer amount $ ->");
            amount45 = scanner.nextDouble();
            account4 = new BankAccount(acc4, id4, money4);
            account5 = new BankAccount(acc5, id5, money5);

        } while (!account5.moneyTransfer(account4, amount45));
